    ...
    return (
        <div className="space-y-6">
            <div className="mx-auto grid max-w-3xl grid-cols-6 gap-6 px-6 pt-16 select-none">
                <div className="col-span-6 flex h-64 md:h-48 flex-col justify-between overflow-hidden rounded-2xl p-4 pt-5 md:pt-0 md:px-8 md:py-5 bg-purple-200 dark:border-purple-500 dark:bg-purple-500/20 dark:shadow-none dark:backdrop-blur-2xl md:col-span-6">
